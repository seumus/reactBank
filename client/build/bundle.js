...
/***/ function(module, exports, __webpack_require__) {
	...
	var AccountForm = __webpack_require__(165);
	var AccountInfoBox = __webpack_require__(166);
	...
	var BankBox = React.createClass({
	  ...
	  sortAccounts: function sortAccounts(type) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        'Total: ',
	        this.getTotal(this.state.accounts).toFixed(2)
	      ),
	      React.createElement(
	        'div',
	        null,
	      ...
	      React.createElement(AccountForm, { onAddAccount: this.addAccount })
	    );
	  }
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        'Total: ',
	        this.props.getTotal(this.props.data).toFixed(2)
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AccountForm = React.createClass({
	  ...
	  handleOwnerChange: function handleOwnerChange(event) {
	    this.setState({ owner: event.target.value });
	  },
	
	  handleAmountChange: function handleAmountChange(event) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        "Amount: ",
	        React.createElement("input", { type: "number", value: this.state.amount, onChange: this.handleAmountChange })
	      ),
	      React.createElement(
	        "label",
	        null,
	        ...
	        React.createElement(
	          "select",
	          { onChange: this.handleTypeChange, value: this.state.type },
	          React.createElement(
	            "option",
	            { value: "Personal" },
	            "Personal"
